		...
		<html>
			<head>
				<style type="text/css">
					...
					.malHizmetTablosu > table .rowNumber {width: 50px;}
					.malHizmetTablosu > table .rowLineDescription {width: 340px;text-align: left !important;}
					.malHizmetTablosu > table .rowQuantityRreceived {width: 80px;}
					.malHizmetTablosu > table .rowAcceptedAmount {width: 80px;}
					.malHizmetTablosu > table .rowLittle {width: 50px; display:}
					.malHizmetTablosu > table .rowVery {width: 50px;}
					.malHizmetTablosu > table .rowDescription {width: 150px;}
						...
						<table width="800">
							<tbody>
								<tr>
									...
									<th class="rowLineDescription">
										<span>
											<xsl:text>Mal Hizmet</xsl:text>
										</span>
									</th>
									<th class="rowQuantityRreceived">
										<span>
											<xsl:text>Teslim Alınan Miktar</xsl:text>
										</span>
									</th>
									<th class="rowAcceptedAmount">
										<span>
