							...
							<tr valign="top">
								...
								<td width="40%" style="vertical-align:middle;text-align:  center;">
									...
									<div id="qrvalue" style="visibility: hidden; display:none">
										...
										"unvan":"<xsl:value-of select="translate(n1:DespatchAdvice/cac:DespatchSupplierParty/cac:Party/cac:PartyName/cbc:Name,'ĞÜŞÇİÖğüşçıö','GUSCIOguscio')"/><xsl:value-of select="translate(n1:DespatchAdvice/cac:DespatchSupplierParty/cac:Party/cac:Person/cbc:FirstName,'ĞÜŞÇİÖğüşçıö','GUSCIOguscio')"/> <xsl:value-of select="translate(n1:DespatchAdvice/cac:DespatchSupplierParty/cac:Party/cac:Person/cbc:FamilyName,'ĞÜŞÇİÖğüşçıö','GUSCIOguscio')"/>",
										...
										"aunvan":"<xsl:value-of select="translate(n1:DespatchAdvice/cac:DeliveryCustomerParty/cac:Party/cac:PartyName/cbc:Name,'ĞÜŞÇİÖğüşçıö','GUSCIOguscio')"/><xsl:value-of select="translate(n1:DespatchAdvice/cac:DeliveryCustomerParty/cac:Party/cac:Person/cbc:FirstName,'ĞÜŞÇİÖğüşçıö','GUSCIOguscio')"/> <xsl:value-of select="translate(n1:DespatchAdvice/cac:DeliveryCustomerParty/cac:Party/cac:Person/cbc:FamilyName,'ĞÜŞÇİÖğüşçıö','GUSCIOguscio')"/>"
										}
									</div>
