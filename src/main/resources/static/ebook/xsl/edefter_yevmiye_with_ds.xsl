...
<!--PROLOG-->
   ...
   <!--PATTERN kok-->
	  ...
	  <!--RULE -->
   <xsl:template match="*" priority="102" mode="M17">
	  ...
	  <!--RULE -->
   <xsl:template match="/" priority="101" mode="M17">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>Yevmiye defteri dokumanı edefter:defter ana elemanı ile başlamalıdır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M17"/>
   ...
   <xsl:template match="/edefter:defter/xbrli:xbrl/xbrli:context/xbrli:entity"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>xbrli:segment/gl-cor:uniqueID elemanı sadece beratlarda bulunabilir.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN defter-->
	  ...
	  <!--RULE -->
   <xsl:template match="/edefter:defter" priority="101" mode="M19">
   ...
   <!--PATTERN signature-->
	  ...
	  <!--RULE -->
   <xsl:template match="/edefter:defter/ds:Signature" priority="103" mode="M20">
   ...
   <xsl:template match="/edefter:defter/xbrli:xbrl" priority="102" mode="M21">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>iso4217 kod listesindeki değerlerden birini içeren en az 1 measure değeri bulunmalıdır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <xsl:template match="/edefter:defter/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:documentInfo"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:entriesType elemanı yevmiye defteri için 'journal' değerini almalıdır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <xsl:template match="/edefter:defter/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:entryHeader"
		...
		<!--ASSERT -->
      <xsl:choose>
         <xsl:when test="not(following::node()) or not(following::node()/gl-cor:entryNumberCounter) or not(gl-cor:entryNumberCounter) or following::node()/gl-cor:entryNumberCounter = gl-cor:entryNumberCounter + 1"/>
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:entryNumberCounter müteselsil bir değere sahip olmalıdır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>Yevmiye defteri tarihe göre sıralı olmalıdır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:enteredBy zorunlu bir elemandır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:enteredBy elemanı en az iki karakter olmamalıdır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:enteredDate zorunlu bir elemandır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:enteredDate elemanın değeri </xsl:text>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:entryNumberCounter zorunlu bir elemandır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:entryHeader elemanı en az iki gl-cor:entryDetail elemanı içermelidir.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-bus:totalDebit elemanının değeri gl-bus:totalCredit elemanının değerine eşit olmalıdır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-bus:totalDebit değeri, gl-cor:entryDetail elemanı içerisindeki gl-cor:debitCreditCode değeri 'D' ve ya 'debit' olan gl-cor:amount değelerinin toplamına eşit olmalıdır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-bus:totalCredit değeri, gl-cor:entryDetail elemanı içerisindeki gl-cor:debitCreditCode değeri 'C' ve ya 'credit' olan gl-cor:amount değerlerinin toplamına eşit olmalıdır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <xsl:template match="/edefter:defter/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:entryHeader/gl-cor:entryDetail"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
		    ...
		    <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="not(following::node()) or not(following::node()/gl-cor:lineNumber) or not(gl-cor:lineNumber) or following::node()/number(gl-cor:lineNumber) = number(gl-cor:lineNumber) + 1"/>
         <xsl:otherwise>
            <Error>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:lineNumberCounter elemanının değeri bir üst düzeydeki gl-cor:entryNumberCounter elemanının değerine eşit olmalıdır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:postingDate elemanının değeri bir üst düzeydeki gl-cor:enteredDate elemanının değerine eşit olmalıdır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:documentType eleman değerinin 'other' olması durumunda gl-cor:documentTypeDescription zorunlu bir elemandır ve bu elemanın değeri boşluk olmamalıdır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:documentType elemanının değeri 'invoice' (fatura) olması durumunda gl-cor:documentNumber ve gl-cor:documentDate elemanları da olmalıdır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:documentType elemanının değeri 'check' (çek) olması durumunda gl-cor:documentNumber ve gl-cor:documentDate elemanları da olmalıdır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:documentReference elemanının değeri bir üst düzeydeki gl-cor:entryNumber elemanının değerine eşit olmalıdır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-bus:paymentMethod elemanı var ise değeri boşluk olmamalıdır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <xsl:template match="/edefter:defter/extensions/extension/defterek:binaryObject"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>defterek:binaryObject elemanının mimeCode niteliği 'application/pdf' olmalıdır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>defterek:binaryObject elemanının filename niteliğinin son 4 karakteri '.pdf' olmalıdır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text> defterek:binaryObject elemanının değeri boşluk olamaz.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
