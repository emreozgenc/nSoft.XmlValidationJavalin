...
<!--PROLOG-->
   ...
   <xsl:template match="/" priority="101" mode="M18">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>Berat dokümanı edefter:berat ana elemanı ile başlamalıdır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="@*|*|comment()|processing-instruction()" mode="M18"/>
   ...
   <xsl:template match="/edefter:berat/xbrli:xbrl/xbrli:context/xbrli:entity"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text> xbrli:segment/gl-bus:numberOfEntries elemanı sadece yevmiye beratında bulunabilir.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text> Yevmiye beratında xbrli:segment/gl-bus:numberOfEntries zorunlu bir elemandır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text> xbrli:segment/gl-cor:uniqueID zorunlu bir elemandır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>xbrli:segment/gl-cor:uniqueID elemanı UUID formatında olmalıdır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <xsl:template match="/edefter:berat" priority="101" mode="M20">
		...
		<!--ASSERT -->
      <xsl:choose>
         <xsl:when test="ds:SignatureValue"/>
         <xsl:otherwise>
            <Error>
               <xsl:text>ds:SignatureValue zorunlu bir elemandır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <!--PATTERN signature-->
	  ...
	  <!--RULE -->
   <xsl:template match="/edefter:berat/ds:Signature" priority="103" mode="M21">
      <xsl:variable name="signatureMethodAlgorithm"
                    select="ds:SignedInfo/ds:SignatureMethod/@Algorithm"/>

		    <!--ASSERT -->
      <xsl:choose>
         <xsl:when test="ds:SignatureValue/@Id"/>
         <xsl:otherwise>
            <Error>
               <xsl:text>ds:SignatureValue elemanı Id niteliğine sahip olmalıdır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
	  ...
	  <!--RULE -->
   <xsl:template match="/edefter:berat/ds:Signature/ds:KeyInfo/ds:X509Data"
                 priority="102"
                 mode="M21">
	  ...
	  <!--RULE -->
   <xsl:template match="/edefter:berat/ds:Signature/ds:KeyInfo/ds:X509Data/ds:X509SubjectName"
                 priority="101"
                 mode="M21">
   ...
   <!--PATTERN xbrl-->
	  ...
	  <!--RULE -->
   <xsl:template match="/edefter:berat/xbrli:xbrl" priority="102" mode="M22">
   ...
   <xsl:template match="/edefter:berat/xbrli:xbrl/gl-cor:accountingEntries"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text> Vergi detayını temsil edecek gl-cor:entryHeader elemanı sayısı 1 olmalıdır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>Vergi detaysız beratlarda gl-cor:entryHeader elemanı bulunmamalıdır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <xsl:template match="/edefter:berat/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:entryHeader"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:qualifierEntry zorunlu bir elemandır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <xsl:template match="/edefter:berat/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:entryHeader/gl-cor:entryDetail[1]"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:entryHeader elemanının ilk gl-cor:entryDetail elemanının gl-cor:lineNumber değeri 1 olmalıdır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <xsl:template match="/edefter:berat/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:entryHeader"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>Dönem içi değişiklikleri temsil eden gl-cor:entryHeader elemanının gl-cor:qualifierEntry değeri standard olmalıdır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text> Dönem içi değişiklikleri temsil eden gl-cor:entryDetail elemanı sayısı 10 olmalıdır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:account/gl-cor:accountMainID=391, gl-cor:debitCreditCode=D olan 1 gl-cor:entryDetail elemanı olmalıdır. </xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:account/gl-cor:accountMainID=391, gl-cor:debitCreditCode=C olan 1 gl-cor:entryDetail elemanı olmalıdır. </xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:account/gl-cor:accountMainID=191, gl-cor:debitCreditCode=D olan 1 gl-cor:entryDetail elemanı olmalıdır. </xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:account/gl-cor:accountMainID=191, gl-cor:debitCreditCode=C olan 1 gl-cor:entryDetail elemanı olmalıdır. </xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:account/gl-cor:accountMainID=600, gl-cor:debitCreditCode=D olan 1 gl-cor:entryDetail elemanı olmalıdır. </xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:account/gl-cor:accountMainID=600, gl-cor:debitCreditCode=C olan 1 gl-cor:entryDetail elemanı olmalıdır. </xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:account/gl-cor:accountMainID=601, gl-cor:debitCreditCode=D olan 1 gl-cor:entryDetail elemanı olmalıdır. </xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:account/gl-cor:accountMainID=601, gl-cor:debitCreditCode=C olan 1 gl-cor:entryDetail elemanı olmalıdır. </xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:account/gl-cor:accountMainID=602, gl-cor:debitCreditCode=D olan 1 gl-cor:entryDetail elemanı olmalıdır. </xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:account/gl-cor:accountMainID=602, gl-cor:debitCreditCode=C olan 1 gl-cor:entryDetail elemanı olmalıdır. </xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <xsl:template match="/edefter:berat/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:entryHeader[gl-cor:qualifierEntry='standard']/gl-cor:entryDetail"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>Dönem içi değişiklikleri temsil eden gl-cor:entryDetail elemanlarının gl-cor:xbrlInfo/gl-cor:xbrlInclude değeri period_change olmalıdır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <xsl:template match="/edefter:berat/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:entryHeader/gl-cor:entryDetail"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:lineNumber müteselsil bir değere sahip olmalıdır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:xbrlInfo/gl-cor:xbrlInclude elemanı zorunlu bir elemandır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>Vergi detayında hiçbir tutar 0'dan küçük olamaz.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
   ...
   <xsl:template match="/edefter:berat/xbrli:xbrl/gl-cor:accountingEntries/gl-cor:documentInfo"
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:entriesType elemanı yevmiye defteri beratı için 'journal' değerini almalıdır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:entriesType elemanı kebir defteri beratı için 'ledger' değerini almalıdır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:uniqueID elemanı yevmiye defteri için 'YEV' değeri ile başlamalıdır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:uniqueID elemanı yevmiye defteri için 'KEB' değeri ile başlamalıdır.</xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:periodCoveredEnd elemanı gl-cor:periodCoveredStart elemanından büyük veya eşit olmalıdır. </xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <Error>
               <xsl:text>gl-cor:creationDate elemanı gl-cor:periodCoveredEnd elemanından büyük ve ya eşit olmalıdır. </xsl:text>
            </Error>
         </xsl:otherwise>
      </xsl:choose>
